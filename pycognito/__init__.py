...
class Cognito:
    ...
    def verify_software_token(self, code, device_name='no_name'):
        """
    ...
    def set_user_mfa_preference(self, sms_mfa, software_token_mfa, preferred):
        """
        ...
        :param preferred: Which is the priority, SMS or Software Token? The expected value is SMS or SOFTWARE_TOKEN.
        :type preferred: string
        :return:
        """
        sms_mfa_settings = {
                'Enabled': bool(sms_mfa),
                'PreferredMfa': False
        }
        ...
        if preferred == 'SMS':
            ...
            raise ValueError("preferred is not the correct value.\nThe expected value is SMS or SOFTWARE_TOKEN.")
    ...
    def respond_mfa_challenge(self, code):
        challenge_responses = {
            "USERNAME": self.username,
